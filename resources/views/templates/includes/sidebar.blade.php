    ...
    <div class="sidebar-start">
        <div class="sidebar-head">
            <a href="/" class="logo-wrapper" title="Home">
                ...
                <div class="logo-text">
                    <span class="logo-title">SIM Ormawa</span>
            ...
            <ul class="sidebar-body-menu">
                ...
                <li>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="posts.html">Semua Informasi</a>
                        </li>
                        <li>
                            <a href="new-post.html">tambah Informasi baru</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon folder" aria-hidden="true"></span>Data himpunan
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
    ...
    <div class="sidebar-footer">
        <a href="##" class="sidebar-user">
            ...
            <div class="sidebar-user-info">
                <span class="sidebar-user__title">Syeh Biaggie.</span>
